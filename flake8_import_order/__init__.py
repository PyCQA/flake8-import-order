    ...
    def node_sort_key(self, node):
        ...
        for i, flags in enumerate(all_flags):
            ...
            if flag_set == set([False]):
                ...
                flag_union[i] = True
        print names, flag_union
        return key

    def _name_flags(self, name):
        ...
        elif n.id in self.application_import_names:
            flags[2] = True
        ...
        for node in self.visitor.imports:
            if node and prev_node:
                ...
                if node_key[0] < prev_node_key[0]:
                    print node.names, node_key[0]
                    print prev_node.names, prev_node_key[0]
